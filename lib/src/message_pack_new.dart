...
class MessagePack extends Codec<dynamic, Uint8List>
  ...
  List<T> unpackAll<T>(Uint8List data) {
    ...
    while (de.hasBytesAvailable) {
      res.add(de.decode() as T);
    }
    return res;
  }

  // --- ExtEncoder / ExtDecoder implementation ---

  @override
  int? extTypeForObject(Object? object) =>
      object == null ? null : _typeCache[object.runtimeType]?.id;

  @override
  Uint8List encodeObject(Object? object) {
    final ext = object == null ? null : _typeCache[object.runtimeType];
    if (ext == null) {
    ...
    final payload = ext.encoder(object, this);
